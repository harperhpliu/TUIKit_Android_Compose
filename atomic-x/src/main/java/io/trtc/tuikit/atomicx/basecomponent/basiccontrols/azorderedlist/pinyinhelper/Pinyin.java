...
public final class Pinyin {
    ...
    private static int getPinyinCode(char c) {
        ...
        if (0 <= offset && offset < PinyinData.PINYIN_CODE_1_OFFSET) {
            ...
            return decodeIndex(
                PinyinCode2.PINYIN_CODE_PADDING, PinyinCode2.PINYIN_CODE, offset - PinyinData.PINYIN_CODE_1_OFFSET);
        } else {
            return decodeIndex(
                PinyinCode3.PINYIN_CODE_PADDING, PinyinCode3.PINYIN_CODE, offset - PinyinData.PINYIN_CODE_2_OFFSET);
        }
    }
