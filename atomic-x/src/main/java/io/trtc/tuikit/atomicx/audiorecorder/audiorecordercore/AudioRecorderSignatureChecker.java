...
public class AudioRecorderSignatureChecker {
    ...
    public static AudioRecorderSignatureChecker getInstance() {
        return AudioRecorderSignatureManagerHolder.sSignatureChecker;
    }
    ...
    private boolean CreateV2TIMManagerReflectCall() {
        ...
        mV2TIMManagerReflectCall =
            new V2TIMManagerReflectCallExperimentalAPI(new V2TIMManagerReflectCallExperimentalAPI.Callback<Object>() {
                @Override
    ...
    private static class AudioRecorderSignatureManagerHolder {
        private static final AudioRecorderSignatureChecker sSignatureChecker = new AudioRecorderSignatureChecker();
    }
