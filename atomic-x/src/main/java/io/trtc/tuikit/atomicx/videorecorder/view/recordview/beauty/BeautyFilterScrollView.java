...
public class BeautyFilterScrollView extends RelativeLayout implements View.OnTouchListener {
    ...
    private final ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener =
            new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
                    ...
                    if (!mRecordCore.isSupportAdvanceFunction()) {
    ...
    public BeautyFilterScrollView(@NonNull Context context, VideoRecorderRecordCore recordCore, BeautyInfo beautyInfo) {
        super(context);
    ...
    private void initViews() {
        inflate(getContext(), R.layout.video_recorder_scroll_filter_view, this);
    ...
    public void doTextAnimator() {
        Log.i(TAG, "doTextAnimator");
        BeautyItem beautyItem = mBeautyFilterType.getSelectedItem();
        if (beautyItem == null) {
            return;
        }
        Log.i(TAG, "doTextAnimator text = " + beautyItem.getName());
