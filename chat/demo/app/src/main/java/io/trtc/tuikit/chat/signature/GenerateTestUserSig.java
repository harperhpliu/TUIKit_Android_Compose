package io.trtc.tuikit.chat.signature;
 ...
 *
 *            The code may be able to calculate UserSig correctly, but it is only for quick testing of the SDK’s basic features, not for commercial
 * applications. SECRETKEY in client code can be easily decompiled and reversed, especially on web. Once your key is disclosed, attackers will be able to steal
 * your Tencent Cloud traffic.
 *
 *            The correct method is to deploy the UserSig calculation code and encryption key on your project server so that your application can request from
 * your server a UserSig that is calculated whenever one is needed. Given that it is more difficult to hack a server than a client application, server-end
 * calculation can better protect your key.
 *
...
public class GenerateTestUserSig {
    ...
    /**
     * Signature expiration time, it is recommended not to set too short
     * <p>
     * Time unit: seconds
     * default time：7 x 24 x 60 x 60 = 604800 = 7 
     */
     ...
     *
     * Note: this method is for testing only. Before commercial launch, please migrate the UserSig calculation code and key to your backend server to prevent
     * key disclosure and traffic stealing. Reference：https://intl.cloud.tencent.com/document/product/1047/34385
     */
     ...
     *
     * The correct method is to deploy the UserSig calculation code and encryption key on your project server so that your application can request from your
     * server a UserSig that is calculated whenever one is needed. Given that it is more difficult to hack a server than a client application, server-end
     * calculation can better protect your key.
     *
     * Reference：https://intl.cloud.tencent.com/document/product/1047/34385
     */
     ...
     * @param userbuf       default is null
     * @param priKeyContent the contents of the private key used to generate the tls ticket
     * @return If there is an error, it will return empty, or there is an exception printed, and a valid ticket is returned successfully
     */
